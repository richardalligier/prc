...
def add_weather(flights,airports,metars,lvar,geo_scale,hour_scale):
...
#    "lon","lat","elevation","tmpf","dwpf","relh","drct","sknt","p01i","alti","mslp","vsby","gust","skyl1","skyl2","skyl3","skyl4","feel"
